...
def xyz():
    ...
    os.getuid
    os.system("clear")
    print('         \x1b[97m[\033[37;41m  THIS COMMAND MADE BY MR ALI\033[0;97m] ')
    ...
    if ALI in ["1","1"]:
        Random()
        os.system("xdg-open https://facebook.com/groups/662059345283007/")
    elif ALI in ["E","e"]:
       exit()
    else:
